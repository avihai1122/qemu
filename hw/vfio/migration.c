...
static void vfio_save_cleanup(void *opaque)
{
    ...
    /*
     * Changing device state from STOP_COPY to STOP can take time (device might
     * need to free resources etc.). Instead of doing it in
     * vfio_save_complete_precopy(), do it here outside of downtime.
     */
